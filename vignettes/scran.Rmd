...
Other analyses can be easily performed with packages in the Bioconductor project, e.g., testing for DE genes with `r Biocpkg("edgeR")`, ordering cells on pseudotime with `r Biocpkg("monocle")`.
